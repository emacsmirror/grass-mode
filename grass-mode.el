...
(define-minor-mode sgrass-mode
  "Toggle sgrass-mode.
Minor mode for editing Grass scripts, and sending commands to a Grass
...
;; Fleshing out the command completion options.

(setq grass-command-updates 
